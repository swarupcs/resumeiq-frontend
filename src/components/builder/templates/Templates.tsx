  ...
  return (
    <div className='p-8 text-gray-900 text-sm leading-relaxed h-full bg-white'>
      ...
      >
        ...
        {pi?.profession && (
          <p className='text-gray-600 mt-1'>{pi.profession}</p>
        )}
  ...
  return (
    <div className='flex h-full text-sm'>
      ...
      >
        ...
        {pi?.profession && (
          <p className='text-center text-white/80 text-xs mb-6'>
            {pi.profession}
          </p>
        )}
        <div className='space-y-2 text-xs mb-6'>
          <h3 className='font-bold uppercase tracking-wider border-b border-white/30 pb-1 mb-2'>
            Contact
          </h3>
          {pi?.email && (
            ...
            <div className='space-y-2'>
              {project.map((proj, i) => (
                ...
                >
                  ...
                  {proj.type && (
                    <p className='text-gray-500 text-xs'>{proj.type}</p>
                  )}
                  {proj.description && (
                    <p className='text-gray-700 text-xs whitespace-pre-line'>
                      {proj.description}
  ...
  return (
    <div className='p-8 text-gray-900 text-sm leading-relaxed h-full bg-white'>
      <div className='mb-6'>
        ...
        {pi?.profession && (
          <p className='text-gray-500 mt-1'>{pi.profession}</p>
        )}
      ...
      <div className='px-8 py-6' style={{ backgroundColor: accentColor }}>
        <div className='flex items-center gap-6'>
          ...
          <div className='text-white'>
            ...
            {pi?.profession && (
              <p className='text-white/90 text-lg mt-1'>{pi.profession}</p>
            )}
