...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    points: 15,
    tip: 'Write a professional summary (≥50 chars)',
  ...
  },
  {
    ...
    points: 20,
    tip: 'Add at least one experience with description',
    check: (r) => r.experience?.some((e) => e.description?.trim()) ?? false,
  },
  {
    key: 'education',
    label: 'Education',
    ...
    check: (r) => (r.education?.length ?? 0) > 0,
  },
  {
    key: 'skills',
    label: 'Skills (5+)',
  ...
  },
  {
    ...
    label: 'Projects',
    points: 10,
    tip: 'Add at least one project with description',
    check: (r) => r.project?.some((p) => p.description?.trim()) ?? false,
  },
];

export const useResumeCompleteness = (
