import { getUserResumesApi, updateProfileApi, type UpdateProfilePayload } from '@/api/user';
...
export const userService = {
  ...
  updateProfile: async (payload: UpdateProfilePayload): Promise<ApiResponse<{ user: User }>> => {
    try {
